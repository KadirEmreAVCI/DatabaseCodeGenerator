...
public:
    ColumnModel(const QString& sName, const QString& sType, bool blIsEnabled, bool blIsPrimaryKey, bool blIsRelationSource, int iRelationID = -1, QObject *parent = nullptr);
